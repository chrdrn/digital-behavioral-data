...
1.  [📢️ Organisation & Koordination](#orga)

2.  [A short (re-)introduction to DBD](#sec2)

3.  [Herausforderungen von DBD](#sec3)

4.  [Wichtige Rahmenbedingungen von DBD](#sec4)
...
# 📢️ Organisation & Koordination {#orga background-image="../../../img/background_orga.png"}
...
# A short (re-)introduction {#sec2 background-color="#E6002E"}
...
# Herausforderungen von DBD {#sec3 background-color="#E6002E"}
...
# Wichtige Rahmenbedingungen von DBD {#sec4 background-color="#E6002E"}
