...
[![Quarto Document](/img/badge-quarto_document.svg)](https://chrdrn.github.io/digital-behavioral-data/content/05-api_access-youtube/05-exercise.html)
...
[![Google Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/chrdrn/digital-behavioral-data/blob/main/session_05-showcase_youtube.ipynb)
...
2.  [[Binder]{.smallcaps}](https://mybinder.org/): Repositories mit Jupyter-Notebooks in ausführbaren Umgebungen öffnen und bearbeiten\
    [![Binder](https://mybinder.org/badge_logo.svg){alt="Binder"}](https://mybinder.org/v2/gh/chrdrn/digital-behavioral-data-binder/HEAD)
...
3.  [[Google Colab]{.smallcaps}](https://colab.research.google.com/): gehosteter Jupyter-Notebook-Dienst, der keine EInrichtung erfordertund gleichzeitig kostenlosen Zugang zu Rechenressourcen einschließlich GPUs bietet\
    [![Google Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/chrdrn/digital-behavioral-data-binder/blob/main/session_05-showcase_youtube.ipynb)
