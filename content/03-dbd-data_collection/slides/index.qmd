...
2.  [Warum Digital Behavioral Data?](#sec2)
3.  [Wie kommen wir an DBD?](#sec3)
4.  [Mehr Daten, mehr Probleme](#sec4)
5.  [Verständnis- & Diskussionsfragen](#verständnis--diskussionsfragen)
6.  [👥 Group Activity]

# 📢 Organisation & Koordination {#orga background-image="../../../img/background_orga.png"}
...
# Warum Digital Behavior Data? {#sec2 background-color="#E6002E"}
...
# Wie kommen wir an DBD? {#sec3 background-color="#E6002E"}
...
# Mehr Daten, mehr Probleme {#sec4 background-color="#E6002E"}
...
# 👥 Group Activity {data-link="Group Activity" background-image="../../../img/background_group_activity.png"}

Gruppenarbeit zu [`WikiWho`](https://www.wikiwho.net/) & [`WhoColor API`](https://api.wikiwho.net/#whocolor_api)
